...
abstract class $PaginationCopyWith<$Res> {
  ...
  @useResult
  $Res call({int pageNumber, int pageSize, int totalRow});
}
...
class _$_Pagination implements _Pagination {
  ...
  @override
  String toString() {
    return 'Pagination(pageNumber: $pageNumber, pageSize: $pageSize, totalRow: $totalRow)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, pageNumber, pageSize, totalRow);
...
abstract class _Pagination implements Pagination {
  factory _Pagination(
      ...
      required final int totalRow}) = _$_Pagination;
